		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Data Soal <small>Dashboard Untuk Melihat Data Soal</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="tables_dynamic.html">Soal</a></li>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Data Soal</h6></div>
				                ...
				                <div class="datatable">
					                <table class="table">
					                    ...
					                    <tbody>
					                            ...
					                            <td>{{ $blog->pilc }}</td>
					                            <td>{{ $blog->pild }}</td>
					                            @if ($blog->correct_answer == 1)
					                            	<td>{{ "A" }}</td>
					                            	@elseif ($blog->correct_answer == 2)
					                            		<td>{{ "B" }}</td>
					                            		@elseif ($blog->correct_answer == 3)
					                            			<td>{{ "C" }}</td>
					                            			@elseif ($blog->correct_answer == 4)
					                            				<td>{{ "D" }}</td>
					                            @endif
												<td>
			                                    ...
			                                    <i class="wb-eye"> Lihat</i>
		                                  		...
		                                  		<a href="{{ url ('soal') }}/{{ $blog->id }}/edit" class="btn btn-info">
                            ...
                            aria-labelledby="exampleModalPrimary" role="dialog" tabindex="-1">
                              <div class="modal-dialog modal-center">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    {!! Form::open(array('class' => 'form-inline', 'method' => 'DELETE', 'route' => array('soal.destroy', $blog->id))) !!}
