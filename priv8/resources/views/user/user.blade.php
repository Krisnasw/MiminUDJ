		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Data User <small>Dashboard Untuk Melihat Data User</small></h3>
				</div>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Data User</h6></div>
					                ...
					                <table class="table">
					                    ...
					                    <tbody>
		                                    	...
		                                    	<i class="wb-eye"> Lihat</i>
		                                  		...
		                                  		<a href="{{ url('user') }}/{{ $blog->id }}/edit" class="btn btn-info">
                            ...
                            aria-labelledby="exampleModalPrimary" role="dialog" tabindex="-1">
                              <div class="modal-dialog modal-center">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    {!! Form::open(array('class' => 'form-inline', 'method' => 'DELETE', 'route' => array('user.destroy', $blog->id))) !!}
