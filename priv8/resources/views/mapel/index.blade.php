		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Data Mapel <small>Dashboard Untuk Melihat Data Mapel</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="tables_dynamic.html">Mapel</a></li>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Data Mapel</h6></div>
					                ...
					                <table class="table">
					                    ...
					                    <tbody>
			                                    ...
			                                    <i class="wb-eye"> Lihat</i>
		                                  		...
		                                  		<a href="{{ url ('mapel') }}/{{ $blog->id }}/edit" class="btn btn-info">
                              ...
                              <div class="modal-dialog modal-center">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body with-padding">
                                    <p>
										Nama Mata Pelajaran : {{ $blog->napel }}
									</p>
                                  </div>
                            ...
                            aria-labelledby="exampleModalPrimary" role="dialog" tabindex="-1">
                              <div class="modal-dialog modal-center">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    {!! Form::open(array('class' => 'form-inline', 'method' => 'DELETE', 'route' => array('mapel.destroy', $blog->id))) !!}
