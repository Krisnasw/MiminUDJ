		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Data Nilai Kelas X <small>Dashboard Untuk Melihat Data Nilai Kelas X</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li class="active">Data Nilai Kelas X</li>
				</ul>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Data Nilai Kelas X</h6></div>
			                <div class="panel-body">
			                <a class="btn btn-primary btn-xs" href="{{ url('/mimin/export-xls') }}">Export As Excel</a>
				                <div class="datatable">
					                <table class="table">
					                    <thead>
					                        <tr>
