		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Data Nilai Kelas XI <small>Dashboard Untuk Melihat Data Nilai Kelas XI</small></h3>
				</div>
			</div>
			<!-- /page header -->
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li class="active">Data Nilai Kelas XI</li>
				</ul>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Data Nilai Kelas XI</h6></div>
			                <div class="panel-body">
			                <a class="btn btn-primary btn-xs" href="{{ url('/mimin/export-xls/xi') }}">Export As Excel</a>
				                <div class="datatable">
					                <table class="table">
					                    <thead>
					                        <tr>
